...
<div class="main-contant">
    <div class="wrapper">
        ...
        <form action="../controller/addAccountentCheck.php" method="post" enctype="multipart/form-data">
            <table class="tbl-full">
                ...
                <tr>
                    <td colspan="2"> 
                        <input type="submit" name="submit" value=" Add Accountent" class="btn-secondary">
