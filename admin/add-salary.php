...
<div class="main-contant">
    <div class="wrapper">
        ...
        <form action="../controller/addSalaryCheck.php" method="post" enctype="multipart/form-data">
            <table class="tbl-full">
                ...
                <tr>
                    <td>Email: </td>
                    <td> <input type="email" name="email" placeholder="Email" id="date"></td>
                </tr>
                ...
                <tr>
                    <td>Salary: </td>
                    <td> <input type="text" name="salary" placeholder="Salary" id=""></td>
                </tr>

                <tr>
                    <td>Bonus: </td>
                    <td> <input type="text" name="bonus" value="NULL" id="Email"></td>
                </tr>
