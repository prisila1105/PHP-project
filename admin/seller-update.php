...
<div class="main-contant">
    <div class="wrapper">
        ...
        <?php
            ...
            $status= displaySellerbyID($id, $conn);
        
        ?>

        <form action="../controller/updateSellerCheck.php" enctype="multipart/form-data" method="post">
            <table class="tbl-30">
                <tr>
                    <td>Full Name: </td>
                ...
                <tr>
                    <td colspan="2"> 
                        ...
                        <input type="submit" name="submit" value=" Update Seller" class="btn-secondary">
                    </td>
                </tr>
